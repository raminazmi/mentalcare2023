...
const Footer = () => {
    return (
        <>
        <footer
            className="bg-[var(--primary)] text-center lg:px-[180px] text-neutral-200 lg:text-right">
            <div className="mx-6 py-10 text-center md:text-right">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className="">
                        ...
                        <p>
                            مينتال كير للدعم والإرشاد النفسي لكافة فئات المجتمع
                            مع أفضل الاأخصائيين والمرشدين النفسيين
                        </p>
                    </div>
                    <div className="">
                        <h6
