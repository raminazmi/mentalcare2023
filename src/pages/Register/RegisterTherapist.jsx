...
const RegisterTherapist = (emailInput = "") => {
  ...
  return (
    <Card contentClassName="flex flex-col py-14 px-14 bg-white" MainContentClassName=" p-24">
      <h1 className='text-[26px] text-[#26ABE3] font-semibold'>إنشاء حساب كمعالج</h1>
          ...
          <div className="flex justify-center gap-8 items-start  ">
            <div className=''>
              <Controller
                ...
                rules={{ required: true }}
                render={({ field }) =>
                  <InputForm placeholder="اختيار صورة الترخيص"
                    type="file" {...field} />}
              />
              {errors.image && <span className='text-red-500 text-sm'>ادخال  صورة الترخيص مطلوب</span>}
            </div>
            <div className=''>
              <Controller
                name="number"
                ...
                rules={{ required: true }}
                render={({ field }) =>
                  <InputForm placeholder=" رقم الترخيص"
                    type="number" {...field} />}
              />
              {errors.number && <span className='text-red-500 text-sm'>  رقم الترخيص مطلوب</span>}
            </div>
          </div>
        </div>
